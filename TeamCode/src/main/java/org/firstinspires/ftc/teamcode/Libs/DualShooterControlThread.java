...
public class DualShooterControlThread implements Runnable{
    ...
    public DualShooterControlThread(DcMotor motorFlywheel1, DcMotor motorFlywheel2) {
        this.flywheel1 = motorFlywheel1;
        this.flywheel2 = motorFlywheel2;
    }   //end of constructor
    ...
    private void setShooterPower(double powerLevel) {
        this.flywheel1.setPower(powerLevel);
        this.flywheel2.setPower(powerLevel);
    ...
    public void setRPMMeasurments() {
        ...
        this.currentTick = ((Math.abs(flywheel1.getCurrentPosition()) + Math.abs(flywheel2.getCurrentPosition())));
