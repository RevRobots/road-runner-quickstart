...
@Autonomous (name = "Blue Inner", group = "Blue")
public class BlueInner extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory boxCMovements = drive.trajectoryBuilder(new Pose2d(-20, 17.5, Math.toRadians(90)), Math.toRadians(0))
                .splineToLinearHeading(new Pose2d(68, 36, Math.toRadians(90)), Math.toRadians(90))
                .build();

        Trajectory powerShotCMovement = drive.trajectoryBuilder(new Pose2d(68, 36, Math.toRadians(75)), Math.toRadians(90))
